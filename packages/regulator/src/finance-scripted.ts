...
import { ExecutionStore, MemoryStore, ObligationLedger, severityForKind } from "@metacoding.io/regulator-core";
import type { InteractionPolicy, ResultReport, WorkContract } from "@metacoding.io/regulator-protocol";
