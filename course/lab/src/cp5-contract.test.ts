...
import type { ResultReportInput, WorkContract } from "@metacoding/vsm-pi-protocol";
import { ExecutionStore, UNITS_RELATIVE_DIR } from "@metacoding/vsm-pi-core";
import { CONTRACT_ENTRY_TYPE, CONTRACT_SECTION_TAG, REPORT_ENTRY_TYPE, createContractExtension, loadContract } from "./cp5-contract.js";
...
test("checkpoint 5 loads into a real Pi session with the contract supplied as an extension flag", async (t) => {
  ...
  const loader = new DefaultResourceLoader({
    ...
    additionalExtensionPaths: [fileURLToPath(new URL("./cp5-contract.js", import.meta.url))],
